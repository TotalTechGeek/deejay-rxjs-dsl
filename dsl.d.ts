 ...
 */
export function declare(operator: (...args: any[]) => (source: any) => import('rxjs').Observable<any> | import('rxjs').OperatorFunction<any, any>, { immediateFrom, context, defaults, parseDefaults, defaultStart }?: {
    ...
    operator: (...args: any[]) => (source: any) => import('rxjs').Observable<any> | import('rxjs').OperatorFunction<any, any>;
    configuration: {
        immediateFrom: number;
        context: boolean;
        defaults: any[];
